        ...
        for cluster in clusters: # for each cluster
            ...
            for pop in cluster: # for each population in a cluster
                ...
                for target in targets: # for each target
                    ...
                    tot_syn_number = neuron_num*inter_conn
                    ...
                    if type(full_inh) == list and pop in full_inh:
                            ...
                            syn_neuron_inter_neg = {'synapse_model':'inter_population_syn',
                             ...
                             'mu_minus':mu_minus,
                             'Wmax':wmax,
                             'weight':np.random.uniform(-15,-5,tot_syn_number)}
                            #nest.Connect(populations[pop],populations[target],{'rule':'fixed_total_number','N':tot_syn_number,'allow_autapses':False},syn_spec=syn_neuron_inter_neg)
                            nest.Connect(populations[pop],populations[target],{'rule':inter_conn_rule,'N':tot_syn_number,'allow_autapses':False},syn_spec=syn_neuron_inter_neg)
                        ...
                        syn_neuron_inter_pos = {'synapse_model':'inter_population_syn',
                             ...
                             'mu_minus':mu_minus,
                             'Wmax':wmax,
                             'weight':np.random.uniform(9.5,10.5,exc_syn_num)}
                        ...
                        syn_neuron_inter_neg = {'synapse_model':'inter_population_syn',
                             ...
                             'mu_minus':mu_minus,
                             'Wmax':wmax,
                             'weight':np.random.uniform(-15,-5,inh_syn_num)}
                    ...
                    #nest.Connect(populations[pop],populations[target],{'rule':inter_conn_rule,'outdegree':inter_conn,'allow_autapses':False,'allow_multapses':False},syn_spec = syn_neuron_inter)
                        ...
                        nest.Connect(populations[pop],populations[target],{'rule':inter_conn_rule,'N':exc_syn_num,'allow_autapses':False},syn_spec=syn_neuron_inter_pos)
                        nest.Connect(populations[pop],populations[target],{'rule':inter_conn_rule,'N':inh_syn_num,'allow_autapses':False},syn_spec=syn_neuron_inter_neg)
    #! if user has not defined cluster of populations                       
    else:
